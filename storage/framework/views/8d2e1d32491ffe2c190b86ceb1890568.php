...
<div class="d-flex">
    ...
    <div class="sidebar" style="width: 250px;">
        ...
        <a href="<?php echo e(route('admin.packages.index')); ?>" class="active"><i class="bi bi-box-seam me-2"></i> Packages</a>
        <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-auto position-absolute bottom-0 w-100" style="max-width: 250px;">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\kliksoft\resources\views/admin/layout.blade.php ENDPATH**/ ?>